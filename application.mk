...
CUR_PATH = $(shell pwd)	
.PHONY: application
application: prerequirement build_info $(SRC_O) $(SRC_S_O) $(SRC_OS_O) $(TY_IOT_LIB)
ifeq ("${ota_idx}", "1")
	$(LD) $(LFLAGS) -o $(TY_OUTPUT)/$(APP_BIN_NAME)_$(USER_SW_VER).axf  $(OBJ_LIST) $(OBJ_S_LIST) $(OBJ_OS_LIST) $(LIBFLAGS) -T./beken378/build/bk7231_ota.ld
else ifeq ("${ota_idx}", "2")
else
	@echo ===========================================================
